...
export default {
  ...
  data() {
    return {
      title: "Fibonaccii",
      task: `Numbers 1,2,3,…n (each integer from 1 to n once) are written on a board. In one operation you can erase any two numbers a and b from the board and write one integer a+b2 rounded up instead.
